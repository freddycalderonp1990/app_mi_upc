...
class MiUpcRegistroUsuarioApiImpl extends MiUpcRegistroUsuarioRepository {
  final MiUpcRegistroUsuarioApiProviderImpl _registroUsuarioApiProviderImpl;
  MiUpcRegistroUsuarioApiImpl(this._registroUsuarioApiProviderImpl);
  ...
  Future<String> insertarUsuario(
    ...
    try {
      return await _registroUsuarioApiProviderImpl.insertarUsuario(
