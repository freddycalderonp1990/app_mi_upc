...
class WorkAreaRegistroPageWidget extends StatefulWidget {
  ...
  @override
  _WorkAreaRegistroPageWidgetState createState() =>
      _WorkAreaRegistroPageWidgetState();
}

class _WorkAreaRegistroPageWidgetState
    extends State<WorkAreaRegistroPageWidget> {
  late double _height;
  late double _width;
  ...
  Widget build(BuildContext context) {
    ...
    _timeController.text =
        DateTime(2023, 03, 07, DateTime.now().hour, DateTime.now().minute)
            .toString();
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DecoratedBox(
                            decoration: BoxDecoration(
                                color: Colors
                                    .white54, //background color of dropdown button
                                border: Border.all(
                                    color: Colors.black38,
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              child: InkWell(
                onTap: () => {Get.offAllNamed(AppRoutesMiUpc.MENU)},
                child: Container(
                  width: responsive.anchoP(35),
                  height: responsive.anchoP(12),
                  child: Column(
  ...
  Future<Null> _selectTime(BuildContext context) async {
    ...
    if (picked != null) {
      setState(() {
        ...
        _timeController.text =
            DateTime(selectedTime.hour, selectedTime.minute).toString();
      });
    }
  }
}
